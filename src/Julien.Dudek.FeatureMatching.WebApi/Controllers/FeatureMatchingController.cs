...
namespace Julien.Dudek.FeatureMatching.WebApi.Controllers;
...
public class FeatureMatchingController : ControllerBase
{
        ...
        files)
    {
        ...
        IList<byte[]> imageSceneDataIlist = new List<byte[]>();
        imageSceneDataIlist.Add(imageSceneData);
        
        var objectDetectionResults= await _objectDetection.DetectObjectInScenes(imageObjectData, imageSceneDataIlist);
